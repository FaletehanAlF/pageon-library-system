...
<?php $c = cover_url($b['cover'] ?? null); ?>
<?php if ($c): ?><img src="<?= e($c) ?>" class="h-40 w-full object-cover"><?php else: ?><div class="h-40 flex items-center justify-center bg-gray-100 text-4xl">📖</div><?php endif; ?>
