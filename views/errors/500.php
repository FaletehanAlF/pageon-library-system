...
<body class="bg-gray-50 flex items-center justify-center min-h-screen p-6">
    <div class="text-center max-w-md">
        <p class="text-sm font-medium text-gray-400">Error 500</p>
        <h1 class="mt-2 text-3xl font-bold tracking-tight">Terjadi kesalahan</h1>
        <p class="mt-3 text-gray-600">Maaf, ada yang tidak beres di sisi server. Silakan coba lagi nanti.</p>
